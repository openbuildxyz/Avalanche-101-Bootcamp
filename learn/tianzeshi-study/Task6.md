...
![成功注册并登录的截图](./login.png)
![钱包截图](./wallet.png)
![Circle Faucet 领取成功的截图](./usdc-received.png)
![Playground 中与 Recruiting Agent (SDK) 交互的关键过程截图](./agent.png)
![Playground 中与 Recruiting Agent (SDK) 交互的关键过程截图](./agent1.png)
![Playground 中与 Recruiting Agent (SDK) 交互的关键过程截图](./agent2.png)
