...
| :---: | :---: |
| ![Passkey 创建](./task6/01-email-verified-passkey.png) | ![Overview 主页](./task6/02-passport-overview.png) |
...
| :---: | :---: |
| ![充值地址](./task6/03-receive-address-modal.png) | ![Circle Faucet](./task6/04-circle-faucet-success.png) |
...
| :---: | :---: |
| ![选择 Agent](./task6/05-playground-hiring-proposal.png) | ![询价提案](./task6/06-playground-ask-quote.png) |

#### (2) 会话授权与资金托管（Escrow）
- 点击 `Tap passkey to begin` 调用系统 Passkey 签署会话授权（Session Limit 50 USDC）。
- 智能合约建立并锁定 `2.00 USDC` 托管资金（Escrow Funded），保障双方协议履行。

![Passkey 授权会话与资金托管](./task6/07-session-approved.png)
...
| :---: | :---: |
| ![Seller 交付](./task6/08-seller-delivered.png) | ![资金释放达成](./task6/09-funds-released-success.png) |
