...
前面忘记截图了，但是这个界面应该也能证明成功注册
![alt text](task6(1)Purple.png)

- 钱包地址 + Circle Faucet 领取成功的截图

![alt text](task6(2)Purple.png)
...
![alt text](task6(5)Purple.png) 
![alt text](task6(3)Purple.png) 
![alt text](task6(4)Purple.png)
